...
def sort_by_plz_add_geometry(dfr, dfg, pdict):
    "Sort df by plz and add to geometry"
    dframe                  = dfr.copy()
    df_geo                  = dfg.copy()
...
def make_streamlit_electric_Charging_resid(dfr1, dfr2):
    ...
    if layer_selection == "Residents":
        ...
        color_map = LinearColormap(colors=['yellow', 'red'], vmin=dframe1['Number'].min(), vmax=10)
