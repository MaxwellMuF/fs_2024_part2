...
class DataValidator:
    def __init__(self, data_of_one_user: dict, expected_columns: list):
        self.data = data_of_one_user

    def __call__(self, *args, **kwds):
        pass

    def check_required_columns_exist(self, required_columns: list) -> bool:
        """Check if all required columns exist in the data."""
        return set(required_columns).issubset(self.data.keys())

    def check_columns_types(self, column_types: dict) -> bool:
    ...
    def check_required_column_values_not_empty(self, required_columns: list) -> bool:
