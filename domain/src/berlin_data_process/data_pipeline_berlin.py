...
def activate_pipeline_berlin():
    # data paths
    path_raw_data = "infrastructure/data/raw_data"
    path_processed_data = "domain/data/processed_data_for_ui"
    ...
    df_charging_raw = pd.read_csv(f"{path_raw_data}/Ladesaeulenregister.csv", sep=",")
    df_residents_raw = pd.read_csv(f"{path_raw_data}/plz_einwohner.csv", sep=",")
    df_geodata_raw = pd.read_csv(f"{path_raw_data}/geodata_berlin_plz.csv", sep=",")
    ...
    df_charging_berlin.to_csv(f"{path_processed_data}/Ladesaeulenregister.csv", index=False)
    df_residents_berlin.to_csv(f"{path_processed_data}/plz_einwohner.csv", index=False)
    df_geodata_raw.to_csv(f"{path_processed_data}/geodata_berlin_plz.csv", index=False)
